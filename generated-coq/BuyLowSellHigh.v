...
fun _ => ((Done _ _ _ 0%Z) >>= fun x => ((divIntUnsigned (numberLocalGet arrayIndex0 (arrayType _ environment0) varsfuncdef_0__main (vardef_0__main_sum)) ((Done _ _ _ 72057594037927936%Z) >>= fun x => Done _ _ _ (coerceInt x 64))) >>= fun x => Done _ _ _ (coerceInt x 8)) >>= fun y => setByte arrayIndex0 (arrayType _ environment0) varsfuncdef_0__main x y) >>=
fun _ => ((Done _ _ _ 1%Z) >>= fun x => ((modIntUnsigned (divIntUnsigned (numberLocalGet arrayIndex0 (arrayType _ environment0) varsfuncdef_0__main (vardef_0__main_sum)) ((Done _ _ _ 281474976710656%Z) >>= fun x => Done _ _ _ (coerceInt x 64))) ((Done _ _ _ 256%Z) >>= fun x => Done _ _ _ (coerceInt x 64))) >>= fun x => Done _ _ _ (coerceInt x 8)) >>= fun y => setByte arrayIndex0 (arrayType _ environment0) varsfuncdef_0__main x y) >>=
fun _ => ((Done _ _ _ 2%Z) >>= fun x => ((modIntUnsigned (divIntUnsigned (numberLocalGet arrayIndex0 (arrayType _ environment0) varsfuncdef_0__main (vardef_0__main_sum)) ((Done _ _ _ 1099511627776%Z) >>= fun x => Done _ _ _ (coerceInt x 64))) ((Done _ _ _ 256%Z) >>= fun x => Done _ _ _ (coerceInt x 64))) >>= fun x => Done _ _ _ (coerceInt x 8)) >>= fun y => setByte arrayIndex0 (arrayType _ environment0) varsfuncdef_0__main x y) >>=
fun _ => ((Done _ _ _ 3%Z) >>= fun x => ((modIntUnsigned (divIntUnsigned (numberLocalGet arrayIndex0 (arrayType _ environment0) varsfuncdef_0__main (vardef_0__main_sum)) ((Done _ _ _ 4294967296%Z) >>= fun x => Done _ _ _ (coerceInt x 64))) ((Done _ _ _ 256%Z) >>= fun x => Done _ _ _ (coerceInt x 64))) >>= fun x => Done _ _ _ (coerceInt x 8)) >>= fun y => setByte arrayIndex0 (arrayType _ environment0) varsfuncdef_0__main x y) >>=
fun _ => ((Done _ _ _ 4%Z) >>= fun x => ((modIntUnsigned (divIntUnsigned (numberLocalGet arrayIndex0 (arrayType _ environment0) varsfuncdef_0__main (vardef_0__main_sum)) ((Done _ _ _ 16777216%Z) >>= fun x => Done _ _ _ (coerceInt x 64))) ((Done _ _ _ 256%Z) >>= fun x => Done _ _ _ (coerceInt x 64))) >>= fun x => Done _ _ _ (coerceInt x 8)) >>= fun y => setByte arrayIndex0 (arrayType _ environment0) varsfuncdef_0__main x y) >>=
fun _ => ((Done _ _ _ 5%Z) >>= fun x => ((modIntUnsigned (divIntUnsigned (numberLocalGet arrayIndex0 (arrayType _ environment0) varsfuncdef_0__main (vardef_0__main_sum)) ((Done _ _ _ 65536%Z) >>= fun x => Done _ _ _ (coerceInt x 64))) ((Done _ _ _ 256%Z) >>= fun x => Done _ _ _ (coerceInt x 64))) >>= fun x => Done _ _ _ (coerceInt x 8)) >>= fun y => setByte arrayIndex0 (arrayType _ environment0) varsfuncdef_0__main x y) >>=
fun _ => ((Done _ _ _ 6%Z) >>= fun x => ((modIntUnsigned (divIntUnsigned (numberLocalGet arrayIndex0 (arrayType _ environment0) varsfuncdef_0__main (vardef_0__main_sum)) ((Done _ _ _ 256%Z) >>= fun x => Done _ _ _ (coerceInt x 64))) ((Done _ _ _ 256%Z) >>= fun x => Done _ _ _ (coerceInt x 64))) >>= fun x => Done _ _ _ (coerceInt x 8)) >>= fun y => setByte arrayIndex0 (arrayType _ environment0) varsfuncdef_0__main x y) >>=
fun _ => ((Done _ _ _ 7%Z) >>= fun x => ((modIntUnsigned (numberLocalGet arrayIndex0 (arrayType _ environment0) varsfuncdef_0__main (vardef_0__main_sum)) ((Done _ _ _ 256%Z) >>= fun x => Done _ _ _ (coerceInt x 64))) >>= fun x => Done _ _ _ (coerceInt x 8)) >>= fun y => setByte arrayIndex0 (arrayType _ environment0) varsfuncdef_0__main x y) >>=
fun _ => Done _ _ _ tt).
