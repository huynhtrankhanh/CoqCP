...
${currentIndent}${indent}(bool success, bytes memory returnData) = address(${generateValueType(instruction.address).expression}).call{value: ${generateValueType(instruction.money).expression}}(callData);
