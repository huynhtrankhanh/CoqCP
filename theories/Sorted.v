...
Definition suffixSorted {A : Type} (default : A) (compare : A -> A -> bool) (l : list A) (suffixLength : nat) := forall i j, i < j -> length l - suffixLength <= i -> j < length l -> ~compare (nth j l default) (nth i l default).
