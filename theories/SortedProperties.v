...
Proof.
  ...
  - destruct l2 as [| a l2].
    ...
    + assert (hEq : a = a0).
      { pose proof proj2 (elem_of_Permutation (a0 :: l1) a) ltac:(now exists l2) as H1.
        pose proof proj2 (elem_of_Permutation (a :: l2) a0) ltac:(now exists l1) as H2.
        rewrite elemOfIff in *.
        destruct (In_nth (a0 :: l1) a default ltac:(assumption)) as [i1 [hi1 hnthi1]].
        destruct (In_nth (a :: l2) a0 default ltac:(assumption)) as [i2 [hi2 hnthi2]].
        destruct i1 as [| i1]; [simpl in hnthi1; rewrite ?hnthi1; reflexivity | idtac].
        destruct i2 as [| i2]; [simpl in hnthi2; rewrite ?hnthi2; reflexivity | idtac].
