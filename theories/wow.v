...
Definition funcdef_0_ReadUnsignedInt64_ (bools : varsfuncdef_0_ReadUnsignedInt64_ -> bool) (numbers : varsfuncdef_0_ReadUnsignedInt64_ -> Z) : Action (WithArrays _ (arrayType _ environment0)) withArraysReturnValue unit := eliminateLocalVariables bools numbers (((Done _ _ _ 0%Z) >>= fun x => numberLocalSet arrayIndex0 (arrayType _ environment0) varsfuncdef_0_ReadUnsignedInt64_ (vardef_0_ReadUnsignedInt64__result) x) >>=
...
Definition funcdef_0_PrintInt64_signed (bools : varsfuncdef_0_PrintInt64_signed -> bool) (numbers : varsfuncdef_0_PrintInt64_signed -> Z) : Action (WithArrays _ (arrayType _ environment1)) withArraysReturnValue unit := eliminateLocalVariables bools numbers ((((numberLocalGet arrayIndex1 (arrayType _ environment1) varsfuncdef_0_PrintInt64_signed (vardef_0_PrintInt64_signed_num)) >>= fun a => (Done _ _ _ 0%Z) >>= fun b => Done _ _ _ (bool_decide (Z.lt (toSigned64 a) (toSigned64 b)))) >>= fun x => if x then (
  (((numberLocalGet arrayIndex1 (arrayType _ environment1) varsfuncdef_0_PrintInt64_signed (vardef_0_PrintInt64_signed_num)) >>= fun x => Done _ _ _ (-x)) >>= fun x => numberLocalSet arrayIndex1 (arrayType _ environment1) varsfuncdef_0_PrintInt64_signed (vardef_0_PrintInt64_signed_num) x) >>=
...
Definition funcdef_0__increase (bools : varsfuncdef_0__increase -> bool) (numbers : varsfuncdef_0__increase -> Z) : Action (WithArrays _ (arrayType _ environment2)) withArraysReturnValue unit := eliminateLocalVariables bools numbers (((Done _ _ _ 0%Z) >>= fun x => ((addInt64 (numberLocalGet arrayIndex2 (arrayType _ environment2) varsfuncdef_0__increase (vardef_0__increase_idx)) (Done _ _ _ 1%Z)) >>= fun tuple_element_0 => Done _ _ _ (tuple_element_0)) >>= fun y => store arrayIndex2 (arrayType _ environment2) varsfuncdef_0__increase (arraydef_0__idxArray) x y) >>=
...
Definition funcdef_0__query (bools : varsfuncdef_0__query -> bool) (numbers : varsfuncdef_0__query -> Z) : Action (WithArrays _ (arrayType _ environment2)) withArraysReturnValue unit := eliminateLocalVariables bools numbers (((Done _ _ _ 0%Z) >>= fun x => ((Done _ _ _ 0%Z) >>= fun tuple_element_0 => Done _ _ _ (tuple_element_0)) >>= fun y => store arrayIndex2 (arrayType _ environment2) varsfuncdef_0__query (arraydef_0__sumArray) x y) >>=
...
Definition funcdef_0__rangeQuery (bools : varsfuncdef_0__rangeQuery -> bool) (numbers : varsfuncdef_0__rangeQuery -> Z) : Action (WithArrays _ (arrayType _ environment2)) withArraysReturnValue unit := eliminateLocalVariables bools numbers ((((Done _ _ _ (fun x => 0%Z)) >>= fun x => (numberLocalGet arrayIndex2 (arrayType _ environment2) varsfuncdef_0__rangeQuery (vardef_0__rangeQuery_right)) >>= fun y => Done _ _ _ (update x (vardef_0__query_idx) y)) >>= fun x => (Done _ _ _ (fun x => false)) >>= fun y => liftToWithLocalVariables (funcdef_0__query y x)) >>=
...
Definition funcdef_0__update (bools : varsfuncdef_0__update -> bool) (numbers : varsfuncdef_0__update -> Z) : Action (WithArrays _ (arrayType _ environment2)) withArraysReturnValue unit := eliminateLocalVariables bools numbers (((((Done _ _ _ (fun x => 0%Z)) >>= fun x => (numberLocalGet arrayIndex2 (arrayType _ environment2) varsfuncdef_0__update (vardef_0__update_idx)) >>= fun y => Done _ _ _ (update x (vardef_0__rangeQuery_left) y)) >>= fun x => (numberLocalGet arrayIndex2 (arrayType _ environment2) varsfuncdef_0__update (vardef_0__update_idx)) >>= fun y => Done _ _ _ (update x (vardef_0__rangeQuery_right) y)) >>= fun x => (Done _ _ _ (fun x => false)) >>= fun y => liftToWithLocalVariables (funcdef_0__rangeQuery y x)) >>=
...
Definition funcdef_0__main (bools : varsfuncdef_0__main -> bool) (numbers : varsfuncdef_0__main -> Z) : Action (WithArrays _ (arrayType _ environment2)) withArraysReturnValue unit := eliminateLocalVariables bools numbers (((Done _ _ _ (fun x => 0%Z)) >>= fun x => (Done _ _ _ (fun x => false)) >>= fun y => liftToWithLocalVariables (translateArrays (funcdef_0_ReadUnsignedInt64_ y x) (arrayType _ environment2) (fun name => match name with| arraydef_0_ReadUnsignedInt64_resultArray => arraydef_0__resultArray end) (fun name => ltac:(destruct name; reflexivity)))) >>=
...
fun _ => (((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__main (arraydef_0__n) x) >>= fun x => loop (Z.to_nat x) (fun binder_0_intermediate => let binder_0 := Done (WithLocalVariables arrayIndex2 (arrayType _ environment2) varsfuncdef_0__main) withLocalVariablesReturnValue _ (Z.sub (Z.sub x (Z.of_nat binder_0_intermediate)) 1%Z) in dropWithinLoop ((
  (liftToWithinLoop ((Done _ _ _ (fun x => 0%Z)) >>= fun x => (Done _ _ _ (fun x => false)) >>= fun y => liftToWithLocalVariables (translateArrays (funcdef_0_ReadUnsignedInt64_ y x) (arrayType _ environment2) (fun name => match name with| arraydef_0_ReadUnsignedInt64_resultArray => arraydef_0__resultArray end) (fun name => ltac:(destruct name; reflexivity))))) >>=
