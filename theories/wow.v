...
Definition funcdef_0_ReadUnsignedInt64_ (bools : varsfuncdef_0_ReadUnsignedInt64_ -> bool) (numbers : varsfuncdef_0_ReadUnsignedInt64_ -> Z) : Action (WithArrays _ (arrayType _ environment0)) withArraysReturnValue unit := eliminateLocalVariables bools numbers (Done _ _ _ tt >>=
fun _ => ((Done _ _ _ 0%Z) >>= fun x => numberLocalSet arrayIndex0 (arrayType _ environment0) varsfuncdef_0_ReadUnsignedInt64_ (vardef_0_ReadUnsignedInt64__result) x) >>=
fun _ => ((Done _ _ _ 20%Z) >>= fun x => loop (Z.to_nat x) (fun binder_0_intermediate => let binder_0 := Done (WithLocalVariables arrayIndex0 (arrayType _ environment0) varsfuncdef_0_ReadUnsignedInt64_) withLocalVariablesReturnValue _ (Z.sub (Z.sub x (Z.of_nat binder_0_intermediate)) 1%Z) in dropWithinLoop ((
  Done _ _ _ tt >>=
  fun _ => (liftToWithinLoop ((readChar arrayIndex0 (arrayType _ environment0) varsfuncdef_0_ReadUnsignedInt64_) >>= fun x => numberLocalSet arrayIndex0 (arrayType _ environment0) varsfuncdef_0_ReadUnsignedInt64_ (vardef_0_ReadUnsignedInt64__tmpChar) x)) >>=
  fun _ => ((liftToWithinLoop (shortCircuitOr ((numberLocalGet arrayIndex0 (arrayType _ environment0) varsfuncdef_0_ReadUnsignedInt64_ (vardef_0_ReadUnsignedInt64__tmpChar)) >>= fun a => (Done _ _ _ 48%Z) >>= fun b => Done _ _ _ (bool_decide (Z.lt a b))) (((numberLocalGet arrayIndex0 (arrayType _ environment0) varsfuncdef_0_ReadUnsignedInt64_ (vardef_0_ReadUnsignedInt64__tmpChar)) >>= fun a => (Done _ _ _ 58%Z) >>= fun b => Done _ _ _ (bool_decide (Z.lt a b))) >>= fun x => Done _ _ _ (negb x)))) >>= fun x => if x then (
    Done _ _ _ tt >>=
    fun _ => (continue arrayIndex0 (arrayType _ environment0) varsfuncdef_0_ReadUnsignedInt64_)
  ) else (
    Done _ _ _ tt
  )) >>=
  fun _ => (liftToWithinLoop ((addInt64 (multInt64 (numberLocalGet arrayIndex0 (arrayType _ environment0) varsfuncdef_0_ReadUnsignedInt64_ (vardef_0_ReadUnsignedInt64__result)) (Done _ _ _ 10%Z)) (subInt64 (numberLocalGet arrayIndex0 (arrayType _ environment0) varsfuncdef_0_ReadUnsignedInt64_ (vardef_0_ReadUnsignedInt64__tmpChar)) (Done _ _ _ 48%Z))) >>= fun x => numberLocalSet arrayIndex0 (arrayType _ environment0) varsfuncdef_0_ReadUnsignedInt64_ (vardef_0_ReadUnsignedInt64__result) x)) >>=
...
Definition funcdef_0_PrintInt64_unsigned (bools : varsfuncdef_0_PrintInt64_unsigned -> bool) (numbers : varsfuncdef_0_PrintInt64_unsigned -> Z) : Action (WithArrays _ (arrayType _ environment1)) withArraysReturnValue unit := eliminateLocalVariables bools numbers (Done _ _ _ tt >>=
fun _ => (((numberLocalGet arrayIndex1 (arrayType _ environment1) varsfuncdef_0_PrintInt64_unsigned (vardef_0_PrintInt64_unsigned_num)) >>= fun x => (Done _ _ _ 0%Z) >>= fun y => Done _ _ _ (bool_decide (x = y))) >>= fun x => if x then (
  Done _ _ _ tt >>=
  fun _ => (((Done _ _ _ 48%Z) >>= fun x => Done _ _ _ (coerceInt8 x)) >>= fun x => writeChar arrayIndex1 (arrayType _ environment1) varsfuncdef_0_PrintInt64_unsigned x)
) else (
  Done _ _ _ tt >>=
  fun _ => ((Done _ _ _ 0%Z) >>= fun x => numberLocalSet arrayIndex1 (arrayType _ environment1) varsfuncdef_0_PrintInt64_unsigned (vardef_0_PrintInt64_unsigned_i) x) >>=
  fun _ => ((Done _ _ _ 20%Z) >>= fun x => loop (Z.to_nat x) (fun binder_0_intermediate => let binder_0 := Done (WithLocalVariables arrayIndex1 (arrayType _ environment1) varsfuncdef_0_PrintInt64_unsigned) withLocalVariablesReturnValue _ (Z.sub (Z.sub x (Z.of_nat binder_0_intermediate)) 1%Z) in dropWithinLoop ((
    Done _ _ _ tt >>=
    fun _ => ((liftToWithinLoop ((numberLocalGet arrayIndex1 (arrayType _ environment1) varsfuncdef_0_PrintInt64_unsigned (vardef_0_PrintInt64_unsigned_num)) >>= fun x => (Done _ _ _ 0%Z) >>= fun y => Done _ _ _ (bool_decide (x = y)))) >>= fun x => if x then (
      Done _ _ _ tt >>=
      fun _ => (break arrayIndex1 (arrayType _ environment1) varsfuncdef_0_PrintInt64_unsigned)
    ) else (
      Done _ _ _ tt
    )) >>=
    fun _ => (liftToWithinLoop (((addInt64 (modIntUnsigned (numberLocalGet arrayIndex1 (arrayType _ environment1) varsfuncdef_0_PrintInt64_unsigned (vardef_0_PrintInt64_unsigned_num)) (Done _ _ _ 10%Z)) (Done _ _ _ 48%Z)) >>= fun x => Done _ _ _ (coerceInt8 x)) >>= fun x => numberLocalSet arrayIndex1 (arrayType _ environment1) varsfuncdef_0_PrintInt64_unsigned (vardef_0_PrintInt64_unsigned_tmpChar) x)) >>=
    ...
    fun _ => (liftToWithinLoop ((addInt64 (numberLocalGet arrayIndex1 (arrayType _ environment1) varsfuncdef_0_PrintInt64_unsigned (vardef_0_PrintInt64_unsigned_i)) (Done _ _ _ 1%Z)) >>= fun x => numberLocalSet arrayIndex1 (arrayType _ environment1) varsfuncdef_0_PrintInt64_unsigned (vardef_0_PrintInt64_unsigned_i) x))
  )))) >>=
...
Definition funcdef_0_PrintInt64_signed (bools : varsfuncdef_0_PrintInt64_signed -> bool) (numbers : varsfuncdef_0_PrintInt64_signed -> Z) : Action (WithArrays _ (arrayType _ environment1)) withArraysReturnValue unit := eliminateLocalVariables bools numbers (Done _ _ _ tt >>=
fun _ => (((numberLocalGet arrayIndex1 (arrayType _ environment1) varsfuncdef_0_PrintInt64_signed (vardef_0_PrintInt64_signed_num)) >>= fun a => (Done _ _ _ 0%Z) >>= fun b => Done _ _ _ (bool_decide (Z.lt (toSigned64 a) (toSigned64 b)))) >>= fun x => if x then (
  Done _ _ _ tt >>=
  fun _ => (((numberLocalGet arrayIndex1 (arrayType _ environment1) varsfuncdef_0_PrintInt64_signed (vardef_0_PrintInt64_signed_num)) >>= fun x => Done _ _ _ (-x)) >>= fun x => numberLocalSet arrayIndex1 (arrayType _ environment1) varsfuncdef_0_PrintInt64_signed (vardef_0_PrintInt64_signed_num) x) >>=
  fun _ => (((Done _ _ _ 45%Z) >>= fun x => Done _ _ _ (coerceInt8 x)) >>= fun x => writeChar arrayIndex1 (arrayType _ environment1) varsfuncdef_0_PrintInt64_signed x)
) else (
  Done _ _ _ tt
)) >>=
fun _ => (((Done _ _ _ (fun x => 0%Z)) >>= fun x => (numberLocalGet arrayIndex1 (arrayType _ environment1) varsfuncdef_0_PrintInt64_signed (vardef_0_PrintInt64_signed_num)) >>= fun y => Done _ _ _ (update x (vardef_0_PrintInt64_unsigned_num) y)) >>= fun x => (Done _ _ _ (fun x => false)) >>= fun y => liftToWithLocalVariables (funcdef_0_PrintInt64_unsigned y x))).
...
Definition funcdef_0__increase (bools : varsfuncdef_0__increase -> bool) (numbers : varsfuncdef_0__increase -> Z) : Action (WithArrays _ (arrayType _ environment2)) withArraysReturnValue unit := eliminateLocalVariables bools numbers (Done _ _ _ tt >>=
fun _ => ((Done _ _ _ 0%Z) >>= fun x => ((addInt64 (numberLocalGet arrayIndex2 (arrayType _ environment2) varsfuncdef_0__increase (vardef_0__increase_idx)) (Done _ _ _ 1%Z)) >>= fun tuple_element_0 => Done _ _ _ (tuple_element_0)) >>= fun y => store arrayIndex2 (arrayType _ environment2) varsfuncdef_0__increase (arraydef_0__idxArray) x y) >>=
...
fun _ => ((Done _ _ _ 30%Z) >>= fun x => loop (Z.to_nat x) (fun binder_0_intermediate => let binder_0 := Done (WithLocalVariables arrayIndex2 (arrayType _ environment2) varsfuncdef_0__increase) withLocalVariablesReturnValue _ (Z.sub (Z.sub x (Z.of_nat binder_0_intermediate)) 1%Z) in dropWithinLoop ((
  Done _ _ _ tt >>=
  fun _ => ((liftToWithinLoop (((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__increase (arraydef_0__n) x) >>= fun a => ((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__increase (arraydef_0__idxArray) x) >>= fun b => Done _ _ _ (bool_decide (Z.lt a b)))) >>= fun x => if x then (
    Done _ _ _ tt >>=
    fun _ => (break arrayIndex2 (arrayType _ environment2) varsfuncdef_0__increase)
  ) else (
    Done _ _ _ tt
  )) >>=
  fun _ => (liftToWithinLoop (((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__increase (arraydef_0__idxArray) x) >>= fun x => ((addInt64 (((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__increase (arraydef_0__idxArray) x) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__increase (arraydef_0__fenwick) x) ((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__increase (arraydef_0__valueArray) x)) >>= fun tuple_element_0 => Done _ _ _ (tuple_element_0)) >>= fun y => store arrayIndex2 (arrayType _ environment2) varsfuncdef_0__increase (arraydef_0__fenwick) x y)) >>=
  fun _ => (liftToWithinLoop ((Done _ _ _ 0%Z) >>= fun x => ((addInt64 ((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__increase (arraydef_0__idxArray) x) (andBits ((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__increase (arraydef_0__idxArray) x) (((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__increase (arraydef_0__idxArray) x) >>= fun x => Done _ _ _ (-x)))) >>= fun tuple_element_0 => Done _ _ _ (tuple_element_0)) >>= fun y => store arrayIndex2 (arrayType _ environment2) varsfuncdef_0__increase (arraydef_0__idxArray) x y))
))))).
...
Definition funcdef_0__query (bools : varsfuncdef_0__query -> bool) (numbers : varsfuncdef_0__query -> Z) : Action (WithArrays _ (arrayType _ environment2)) withArraysReturnValue unit := eliminateLocalVariables bools numbers (Done _ _ _ tt >>=
fun _ => ((Done _ _ _ 0%Z) >>= fun x => ((Done _ _ _ 0%Z) >>= fun tuple_element_0 => Done _ _ _ (tuple_element_0)) >>= fun y => store arrayIndex2 (arrayType _ environment2) varsfuncdef_0__query (arraydef_0__sumArray) x y) >>=
fun _ => ((Done _ _ _ 0%Z) >>= fun x => ((addInt64 (numberLocalGet arrayIndex2 (arrayType _ environment2) varsfuncdef_0__query (vardef_0__query_idx)) (Done _ _ _ 1%Z)) >>= fun tuple_element_0 => Done _ _ _ (tuple_element_0)) >>= fun y => store arrayIndex2 (arrayType _ environment2) varsfuncdef_0__query (arraydef_0__idxArray) x y) >>=
fun _ => ((Done _ _ _ 30%Z) >>= fun x => loop (Z.to_nat x) (fun binder_0_intermediate => let binder_0 := Done (WithLocalVariables arrayIndex2 (arrayType _ environment2) varsfuncdef_0__query) withLocalVariablesReturnValue _ (Z.sub (Z.sub x (Z.of_nat binder_0_intermediate)) 1%Z) in dropWithinLoop ((
  Done _ _ _ tt >>=
  fun _ => ((liftToWithinLoop (((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__query (arraydef_0__idxArray) x) >>= fun a => (Done _ _ _ 1%Z) >>= fun b => Done _ _ _ (bool_decide (Z.lt a b)))) >>= fun x => if x then (
    Done _ _ _ tt >>=
    fun _ => (break arrayIndex2 (arrayType _ environment2) varsfuncdef_0__query)
  ) else (
    Done _ _ _ tt
  )) >>=
  fun _ => (liftToWithinLoop ((Done _ _ _ 0%Z) >>= fun x => ((addInt64 ((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__query (arraydef_0__sumArray) x) (((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__query (arraydef_0__idxArray) x) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__query (arraydef_0__fenwick) x)) >>= fun tuple_element_0 => Done _ _ _ (tuple_element_0)) >>= fun y => store arrayIndex2 (arrayType _ environment2) varsfuncdef_0__query (arraydef_0__sumArray) x y)) >>=
  fun _ => (liftToWithinLoop ((Done _ _ _ 0%Z) >>= fun x => ((subInt64 ((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__query (arraydef_0__idxArray) x) (andBits ((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__query (arraydef_0__idxArray) x) (((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__query (arraydef_0__idxArray) x) >>= fun x => Done _ _ _ (-x)))) >>= fun tuple_element_0 => Done _ _ _ (tuple_element_0)) >>= fun y => store arrayIndex2 (arrayType _ environment2) varsfuncdef_0__query (arraydef_0__idxArray) x y))
)))) >>=
...
Definition funcdef_0__rangeQuery (bools : varsfuncdef_0__rangeQuery -> bool) (numbers : varsfuncdef_0__rangeQuery -> Z) : Action (WithArrays _ (arrayType _ environment2)) withArraysReturnValue unit := eliminateLocalVariables bools numbers (Done _ _ _ tt >>=
fun _ => (((Done _ _ _ (fun x => 0%Z)) >>= fun x => (numberLocalGet arrayIndex2 (arrayType _ environment2) varsfuncdef_0__rangeQuery (vardef_0__rangeQuery_right)) >>= fun y => Done _ _ _ (update x (vardef_0__query_idx) y)) >>= fun x => (Done _ _ _ (fun x => false)) >>= fun y => liftToWithLocalVariables (funcdef_0__query y x)) >>=
...
fun _ => (((Done _ _ _ (fun x => 0%Z)) >>= fun x => (subInt64 (numberLocalGet arrayIndex2 (arrayType _ environment2) varsfuncdef_0__rangeQuery (vardef_0__rangeQuery_left)) (Done _ _ _ 1%Z)) >>= fun y => Done _ _ _ (update x (vardef_0__query_idx) y)) >>= fun x => (Done _ _ _ (fun x => false)) >>= fun y => liftToWithLocalVariables (funcdef_0__query y x)) >>=
fun _ => ((Done _ _ _ 0%Z) >>= fun x => ((subInt64 ((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__rangeQuery (arraydef_0__tempArray) x) ((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__rangeQuery (arraydef_0__resultArray) x)) >>= fun tuple_element_0 => Done _ _ _ (tuple_element_0)) >>= fun y => store arrayIndex2 (arrayType _ environment2) varsfuncdef_0__rangeQuery (arraydef_0__tempArray) x y) >>=
...
Definition funcdef_0__update (bools : varsfuncdef_0__update -> bool) (numbers : varsfuncdef_0__update -> Z) : Action (WithArrays _ (arrayType _ environment2)) withArraysReturnValue unit := eliminateLocalVariables bools numbers (Done _ _ _ tt >>=
fun _ => ((((Done _ _ _ (fun x => 0%Z)) >>= fun x => (numberLocalGet arrayIndex2 (arrayType _ environment2) varsfuncdef_0__update (vardef_0__update_idx)) >>= fun y => Done _ _ _ (update x (vardef_0__rangeQuery_left) y)) >>= fun x => (numberLocalGet arrayIndex2 (arrayType _ environment2) varsfuncdef_0__update (vardef_0__update_idx)) >>= fun y => Done _ _ _ (update x (vardef_0__rangeQuery_right) y)) >>= fun x => (Done _ _ _ (fun x => false)) >>= fun y => liftToWithLocalVariables (funcdef_0__rangeQuery y x)) >>=
...
fun _ => ((Done _ _ _ 0%Z) >>= fun x => ((subInt64 (numberLocalGet arrayIndex2 (arrayType _ environment2) varsfuncdef_0__update (vardef_0__update_value)) ((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__update (arraydef_0__tempArray) x)) >>= fun tuple_element_0 => Done _ _ _ (tuple_element_0)) >>= fun y => store arrayIndex2 (arrayType _ environment2) varsfuncdef_0__update (arraydef_0__tempArray) x y) >>=
fun _ => ((((Done _ _ _ (fun x => 0%Z)) >>= fun x => (numberLocalGet arrayIndex2 (arrayType _ environment2) varsfuncdef_0__update (vardef_0__update_idx)) >>= fun y => Done _ _ _ (update x (vardef_0__increase_idx) y)) >>= fun x => ((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__update (arraydef_0__tempArray) x) >>= fun y => Done _ _ _ (update x (vardef_0__increase_value) y)) >>= fun x => (Done _ _ _ (fun x => false)) >>= fun y => liftToWithLocalVariables (funcdef_0__increase y x))).
...
Definition funcdef_0__main (bools : varsfuncdef_0__main -> bool) (numbers : varsfuncdef_0__main -> Z) : Action (WithArrays _ (arrayType _ environment2)) withArraysReturnValue unit := eliminateLocalVariables bools numbers (Done _ _ _ tt >>=
fun _ => ((Done _ _ _ (fun x => 0%Z)) >>= fun x => (Done _ _ _ (fun x => false)) >>= fun y => liftToWithLocalVariables (translateArrays (funcdef_0_ReadUnsignedInt64_ y x) (arrayType _ environment2) (fun name => match name with| arraydef_0_ReadUnsignedInt64_resultArray => arraydef_0__resultArray end) (fun name => ltac:(destruct name; reflexivity)))) >>=
...
fun _ => (((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__main (arraydef_0__n) x) >>= fun x => loop (Z.to_nat x) (fun binder_0_intermediate => let binder_0 := Done (WithLocalVariables arrayIndex2 (arrayType _ environment2) varsfuncdef_0__main) withLocalVariablesReturnValue _ (Z.sub (Z.sub x (Z.of_nat binder_0_intermediate)) 1%Z) in dropWithinLoop ((
  ...
  fun _ => (liftToWithinLoop ((((Done _ _ _ (fun x => 0%Z)) >>= fun x => binder_0 >>= fun y => Done _ _ _ (update x (vardef_0__increase_idx) y)) >>= fun x => ((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__main (arraydef_0__resultArray) x) >>= fun y => Done _ _ _ (update x (vardef_0__increase_value) y)) >>= fun x => (Done _ _ _ (fun x => false)) >>= fun y => liftToWithLocalVariables (funcdef_0__increase y x)))
)))) >>=
fun _ => (((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__main (arraydef_0__q) x) >>= fun x => loop (Z.to_nat x) (fun binder_0_intermediate => let binder_0 := Done (WithLocalVariables arrayIndex2 (arrayType _ environment2) varsfuncdef_0__main) withLocalVariablesReturnValue _ (Z.sub (Z.sub x (Z.of_nat binder_0_intermediate)) 1%Z) in dropWithinLoop ((
  ...
  fun _ => ((liftToWithinLoop (((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__main (arraydef_0__tempArray) x) >>= fun x => (Done _ _ _ 1%Z) >>= fun y => Done _ _ _ (bool_decide (x = y)))) >>= fun x => if x then (
    ...
    fun _ => (liftToWithinLoop ((((Done _ _ _ (fun x => 0%Z)) >>= fun x => (subInt64 ((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__main (arraydef_0__idxArray) x) (Done _ _ _ 1%Z)) >>= fun y => Done _ _ _ (update x (vardef_0__update_idx) y)) >>= fun x => ((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__main (arraydef_0__valueArray) x) >>= fun y => Done _ _ _ (update x (vardef_0__update_value) y)) >>= fun x => (Done _ _ _ (fun x => false)) >>= fun y => liftToWithLocalVariables (funcdef_0__update y x)))
  ) else (
    Done _ _ _ tt >>=
    fun _ => (liftToWithinLoop ((Done _ _ _ (fun x => 0%Z)) >>= fun x => (Done _ _ _ (fun x => false)) >>= fun y => liftToWithLocalVariables (translateArrays (funcdef_0_ReadUnsignedInt64_ y x) (arrayType _ environment2) (fun name => match name with| arraydef_0_ReadUnsignedInt64_resultArray => arraydef_0__resultArray end) (fun name => ltac:(destruct name; reflexivity))))) >>=
    fun _ => (liftToWithinLoop ((Done _ _ _ 0%Z) >>= fun x => (((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__main (arraydef_0__resultArray) x) >>= fun tuple_element_0 => Done _ _ _ (tuple_element_0)) >>= fun y => store arrayIndex2 (arrayType _ environment2) varsfuncdef_0__main (arraydef_0__tempArray) x y)) >>=
    fun _ => (liftToWithinLoop ((((Done _ _ _ (fun x => 0%Z)) >>= fun x => (subInt64 ((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__main (arraydef_0__idxArray) x) (Done _ _ _ 1%Z)) >>= fun y => Done _ _ _ (update x (vardef_0__rangeQuery_left) y)) >>= fun x => (subInt64 ((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__main (arraydef_0__tempArray) x) (Done _ _ _ 1%Z)) >>= fun y => Done _ _ _ (update x (vardef_0__rangeQuery_right) y)) >>= fun x => (Done _ _ _ (fun x => false)) >>= fun y => liftToWithLocalVariables (funcdef_0__rangeQuery y x))) >>=
    fun _ => (liftToWithinLoop (((Done _ _ _ (fun x => 0%Z)) >>= fun x => ((Done _ _ _ 0%Z) >>= fun x => retrieve arrayIndex2 (arrayType _ environment2) varsfuncdef_0__main (arraydef_0__resultArray) x) >>= fun y => Done _ _ _ (update x (vardef_0_PrintInt64_unsigned_num) y)) >>= fun x => (Done _ _ _ (fun x => false)) >>= fun y => liftToWithLocalVariables (translateArrays (funcdef_0_PrintInt64_unsigned y x) (arrayType _ environment2) (fun name => match name with| arraydef_0_PrintInt64_buffer => arraydef_0__printBuffer end) (fun name => ltac:(destruct name; reflexivity))))) >>=
    fun _ => (liftToWithinLoop (((Done _ _ _ 10%Z) >>= fun x => Done _ _ _ (coerceInt8 x)) >>= fun x => writeChar arrayIndex2 (arrayType _ environment2) varsfuncdef_0__main x))
  ))
))))).
