...
procedure("siftUp", { 
  ...
  range(30, (i) => {
    ...
    if (less(retrieve("heap", get("currentIndex"))[0], retrieve("heap", get("parentIndex"))[0])) {
      set("temp", retrieve("heap", get("currentIndex"))[0])
      store("heap", get("currentIndex"), [retrieve("heap", get("parentIndex"))[0]])
...
procedure("siftDown", { 
  ...
  range(30, (i) => {
    ...
    if (less(get("leftChild"), retrieve("heapSize", 0)[0])) {
      if (less(retrieve("heap", get("leftChild"))[0], retrieve("heap", get("smallestIndex"))[0])) {
         set("smallestIndex", get("leftChild"))
      }
    }
    // Check right child.
    if (less(get("rightChild"), retrieve("heapSize", 0)[0])) {
      if (less(retrieve("heap", get("rightChild"))[0], retrieve("heap", get("smallestIndex"))[0])) {
    ...
    set("temp", retrieve("heap", get("currentIndex"))[0])
    store("heap", get("currentIndex"), [retrieve("heap", get("smallestIndex"))[0]])
