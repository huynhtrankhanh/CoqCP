...
procedure(
  'main',
  { count: int64, max: int64, offset: int64, current: int64 },
  () => {
    ...
    if (get('count') != coerceInt64(0)) {
      ...
      range(get('count') - coerceInt64(1), (i) => {
        ...
        set(
          'current',
          coerceInt64(retrieve(get('offset'))) *
            coerceInt64(72057594037927936) +
            coerceInt64(retrieve(get('offset') + coerceInt64(1))) *
              coerceInt64(281474976710656) +
            coerceInt64(retrieve(get('offset') + coerceInt64(2))) *
              coerceInt64(1099511627776) +
            coerceInt64(retrieve(get('offset') + coerceInt64(3))) *
              coerceInt64(4294967296) +
            coerceInt64(retrieve(get('offset') + coerceInt64(4))) *
              coerceInt64(16777216) +
            coerceInt64(retrieve(get('offset') + coerceInt64(5))) *
              coerceInt64(65536) +
            coerceInt64(retrieve(get('offset') + coerceInt64(6))) *
              coerceInt64(256) +
    ...
    store(
      1,
      coerceInt8(
        divide(get('max'), coerceInt64(281474976710656)) % coerceInt64(256)
      )
    )
    store(
      2,
      coerceInt8(
        divide(get('max'), coerceInt64(1099511627776)) % coerceInt64(256)
      )
    )
    store(
      3,
      coerceInt8(divide(get('max'), coerceInt64(4294967296)) % coerceInt64(256))
    )
    store(
      4,
      coerceInt8(divide(get('max'), coerceInt64(16777216)) % coerceInt64(256))
    )
    store(
      5,
      coerceInt8(divide(get('max'), coerceInt64(65536)) % coerceInt64(256))
    )
    store(
      6,
      coerceInt8(divide(get('max'), coerceInt64(256)) % coerceInt64(256))
    )
